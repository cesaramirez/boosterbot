<template>
  <section>
      <div class="mb-6">
          <a class="button is-success rounded font-medium shadow" :href="route('rewards.create')">
              <span class="z-add-solid mr-2"></span>Create Reward
          </a>
      </div>
    <div class="card">
            ...
            <b-table-column field="tools" centered>
              <b-dropdown position="is-bottom-left" class="text-left">
                ...
                <b-dropdown-item has-link>
                  <a :href="route('rewards.edit', props.row.id)">
    ...
    <b-modal :active.sync="modalDelete" :width="300" scroll="keep">
        <div class="card">
            ...
            <footer class="card-footer">
                <form :action="route('rewards.destroy', destroyId)" method="POST" id="delete-reward" class="card-footer-item">
  ...
  computed: {
    filteredList() {
      return this.rewards.filter(reward => {
        return reward.product.toLowerCase().includes(this.search.toLowerCase());
      });
    }
  },
  methods: {
