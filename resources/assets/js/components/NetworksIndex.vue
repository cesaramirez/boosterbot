<template>
  <section>
      <div class="mb-6">
          <a class="button is-success rounded font-medium shadow" :href="route('networks.create')">
              <span class="z-add-solid mr-2"></span>Create Wifi Network
          </a>
      </div>
    <div class="card">
            ...
            <b-table-column field="tools" centered>
              <b-dropdown position="is-bottom-left" class="text-left">
                ...
                <b-dropdown-item has-link>
                  <a :href="route('networks.edit', props.row.id)">
    ...
    <b-modal :active.sync="modalDelete" :width="300" scroll="keep">
        <div class="card">
            ...
            <footer class="card-footer">
                <form :action="route('networks.destroy', destroyId)" method="POST" id="delete-reward" class="card-footer-item">
