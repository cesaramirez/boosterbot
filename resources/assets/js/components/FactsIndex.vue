<template>
  <section>
      <div class="mb-6">
          <a class="button is-success rounded font-medium shadow" :href="route('facts.create')">
              <span class="z-add-solid mr-2"></span>Create Random Fact
          </a>
      </div>
    <div class="card">
            ...
            <b-table-column field="tools" centered>
              <b-dropdown position="is-bottom-left" class="text-left">
                ...
                <b-dropdown-item has-link>
                  <a :href="route('facts.edit', props.row.id)">
    ...
    <b-modal :active.sync="modalDelete" :width="300" scroll="keep">
        <div class="card">
            ...
            <footer class="card-footer">
                <form :action="route('facts.destroy', destroyId)" method="POST" id="delete-reward" class="card-footer-item">
  ...
  computed: {
    filteredList() {
      return this.facts.filter(fact => {
        return fact.text.toLowerCase().includes(this.search.toLowerCase());
      });
    }
  },
  methods: {
